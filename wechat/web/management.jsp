    ...
    <head>
        ...
        <script type="text/javascript">
            onload=function(){
                ...
                var exe_1='<input name="delete" type="submit" class="delete" value="删除"><input type="submit" name="update" class="update" value="修改" onclick="return false;">';
                var exe_2='<input name="sure" type="submit" class="sure" value="修改"><input type="submit" name="cancel" class="cancel" value="取消">';
                var username_text='<input name="updateName" class="update_text" maxlength="10" minlength="3" size="6" value='+username+">";
                var password_txt=<input name="password" class="update_text" maxlength="15" minlength="6" size="6"  value='+password+">"
                ddsdsadsdbbnbggfgfsgfsagfsaagfsaagfsaaagfsaaagfsaagfsagfsgfffdfdffdfdfdfdvfdfdvbfdfdvbzfdfdvbzcfdfdvbzfdfdvbfdfdvfdfdddddggfgfdgfdjgfdgfg
                var cancel=function(){
                    name_txt.text(username);
                    password_txt.text(password);
                    sex_txt.html(sex);
                    $(".sure,.cancel").remove();
                    $(".func").after(exe_1); fdffdf
                ...
                var update=function(e){
                    name_txt=$(e.target).parents("td").siblings().filter(".name");
                    password_txt=$(e.target).parents("td").siblings().filter(".password");
                    sex_txt=$(e.target).parents("td").siblings().filter(".sex");
                    username=name_txt.text();
                    password=password_txt.text();
                    sex=sex_txt.text();
                    name_txt.html('<input name="updateName" class="update_text" maxlength="10" minlength="3" size="6" value='+username+">");
                    password_txt.html('<input name="password" class="update_text" maxlength="15" minlength="6" size="6"  value='+password+">");
                    sex_txt.html('<input name="updateSex" class="update_text" maxlength="1" minlength="1" size="1" value='+sex+">");
...
if(pageBeanSelect!=null){
    for(int i=0;i<num;i++){%>
        <tr>
                ...
                <td class="name"><%=pageBeanSelect.getList().get(i).getUsername()%></td>
                <td class="password"><%=pageBeanSelect.getList().get(i).getPassword()%></td>
                <td class="sex"><%=pageBeanSelect.getList().get(i).getSex()%></td>
                <td class="exe">
                    <form action="ManageUpdateUser" method="get" id="form">                
                            ...
                            <input type="submit" value="修改" class="update" name="update" onclick="return false;">
                    </form> 
                </td>
        </tr>
    <%}%>
