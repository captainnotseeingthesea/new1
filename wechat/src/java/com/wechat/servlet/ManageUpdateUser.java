 ...
 * @author 宣佚
 */
public class ManageUpdateUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("SelectAllUserByCondition").forward(request, response);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ManageUpdateUser.class.getName()).log(Level.SEVERE, null, ex);
